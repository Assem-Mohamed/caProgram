...
public class Ca {
    ...
    public void fetch() {
        ...
        while (registers.getProgramCounter() < 1024) {
    ...
    public void decode(String instruction) {
        ...
        shamt = Integer.toBinaryString(
                Integer.parseInt(instruction.substring(19, 32), 2) & Integer.parseInt("1111111111111", 2));
        shamt = String.format("%13s", shamt).replace(' ', '0');
        imm = Integer.toBinaryString(
                Integer.parseInt(instruction.substring(14, 32), 2) & Integer.parseInt("111111111111111111", 2));
        imm = String.format("%18s", imm).replace(' ', '0');
        jmpAddress = Integer.toBinaryString(Integer.parseInt(instruction.substring(4, 32), 2)
